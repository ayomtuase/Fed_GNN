...
Official implementation of **"Graph-based federated learning approach for intrusion detection in IoT networks"** published in _Scientific Reports_ (2025).
...
- **Privacy preservation** through graph-based feature abstraction
...
### 2. **Graph-level Feature Abstraction**

- Graph-based embeddings preserve structural and temporal traffic patterns
- Aggregation operates on graph features rather than explicit device communities
- Reduces data transfer through compact graph representation
...
_Figure 1: Overview of the FedGATSage architecture showing client-side GAT processing with community detection, server-side GraphSAGE on overlay graph, and bidirectional model parameter updates._
...
_If you do not have a dataset handy, the experiment script can generate synthetic "dummy" data for demonstration purposes._
